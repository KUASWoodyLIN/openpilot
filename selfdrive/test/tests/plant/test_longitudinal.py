...
maneuvers = [
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 0kph from 5m away',
    duration=15.,
    initial_speed=0. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=5.,
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 0kph from 10m away',
    duration=15.,
    initial_speed=0. * CV.KPH_TO_MS,
    person_relevancy=True,
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 0kph from 15m away',
    duration=15.,
    initial_speed=0. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=15.,
    speed_person_values=[0. * CV.MPH_TO_MS, 0. * CV.MPH_TO_MS],
    speed_person_breakpoints=[0., 100.],
    cruise_button_presses=[(CB.DECEL_SET, 0.3), (0, 0.4)]
  ),
  Maneuver(
    'approaching a 0mph Person while cruising at 5kph from 5m away',
    duration=10.,
    initial_speed=5. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=5.,
    speed_person_values=[0. * CV.MPH_TO_MS, 0. * CV.MPH_TO_MS],
    speed_person_breakpoints=[0., 100.],
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 10kph from 5m away',
    duration=10.,
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 5kph from 10m away',
    duration=10.,
    initial_speed=5. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=10.,
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 5kph from 15m away',
    duration=10.,
    initial_speed=5. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=15.,
  ...
  Maneuver(
    'approaching a 0mph Person while cruising at 10kph from 15m away',
    duration=10.,
    initial_speed=10. * CV.KPH_TO_MS,
    person_relevancy=True,
    initial_distance_person=15.,
